    ...
    return (
        <div className=' max-w-10/12 mx-auto  my-10 py-10'>
            <div className='text-center'>
                ...
                <p className='mb-7'>Easily connect with verified, experienced doctors across a wide range of specialties — all from the comfort of <br /> your home. Whether you need a routine checkup or an urgent consultation, book appointments in minutes and receive trusted, high-quality care.</p>
            </div>
